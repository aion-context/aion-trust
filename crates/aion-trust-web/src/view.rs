...
<meta name="description" content="The verifiable résumé: every fact attested once at its source, signed, and verifiable by anyone offline. Issuer console, candidate wallet, and employer verifier.">
<meta name="theme-color" content="#f4f7f3">
<link rel="icon" href="/favicon.svg" type="image/svg+xml">
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Libre+Caslon+Display&family=Libre+Caslon+Text:ital,wght@0,400;0,700;1,400&family=Hanken+Grotesk:wght@400;500;600;700&family=Spline+Sans+Mono:wght@400;500&display=swap" rel="stylesheet">
<link rel="stylesheet" href="/app.css">
</head><body>
<header class="top"><a class="brand" href="/"><img src="/favicon.svg" alt=""><span>aion<span class="dot">·</span>trust</span></a><nav class="surfaces">{nav}</nav></header>
